...
varienGridMassaction.prototype = {
    ...
    apply: function() {
        ...
        if(this.useAjax && item.url) {
			...
			// alert(item.toSource());
			// var test = document.getElementsByName('barcode_ids');
			var data1 = this.form.serialize(true);
			var barcode_ids = data1.barcode_ids;
			var url = item.url + 'barcode/'+barcode_ids;
