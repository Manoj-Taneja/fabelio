...
(function(){
    function r(a,b){
        ...
        var a,b=arguments,c,d={},e=function(a,b){
            var c,d;
            typeof a!=="object"&&(a={});
            for(d in b)b.hasOwnProperty(d)&&(c=b[d],a[d]=c&&typeof c==="object"&&Object.prototype.toString.call(c)!=="[object Array]"&&d!=="renderTo"&&typeof c.nodeType!=="number"?e(a[d]||{},c):b[d]);return a
            };
...
function Pa(a,b){
    ...
    cb=function(a,b,c){
        ...
        for(e in d)for(;a.indexOf("%"+e)!==-1;)a=a.replace("%"+e,typeof d[e]==="function"?d[e](b):d[e]);return c?a.substr(0,1).toUpperCase()+a.substr(1):a
        };
...
E={
    ...
    global:{
        useUTC:!0,
        canvasToolsURL:"modules/canvas-tools.js",
        VMLRadialGradientURL:"modules/images/vml-radial-gradient.png"
    },
    chart:{
        borderColor:"#4572A7",
        borderRadius:0,
...
S.prototype={
    ...
    colorGradient:function(a,b,c){
        ...
        if(f){
            ...
            for(m in g)m!=="id"&&o.push(m,g[m]);for(m in j)o.push(j[m]);o=o.join(",");
...
crisp:function(a){
    ...
    a.strokeWidth=e;
    for(b in a)this[b]!==a[b]&&(this[b]=c[b]=a[b]);return c
    },
css:function(a){
    var b=this.styles,c={},d=this.element,e,f,g="";
    e=!b;
    if(a&&a.color)a.fill=a.color;
    if(b)for(f in a)a[f]!==b[f]&&(c[f]=a[f],e=!0);if(e){
...
K.PlotLineOrBand.prototype={
    render:function(){
        ...
        if(m)if(o)m.animate({
            ...
            },C)d(p);if(f&&s(f.text)&&o&&o.length&&b.width>0&&b.height>0){
            f=w({
                align:c&&k&&"center",
                x:c?!k&&4:10,
...
init:function(a,b){
    ...
    for(f in d)N(this,f,d[f]);if(this.isLog)this.val2lin=za,this.lin2val=ka
        },
...
render:function(){
    ...
    !isNaN(a.oldMin),r=a.hasData,t=a.showAxis,v,w=f.labels.overflow,x=a.justifyLabels=b&&w!==!1,A;
    ...
    q([l,n,
        m],function(a){
            ...
            for(b in a)if(!a[b].isActive)a[b].render(b,!1,0),a[b].isActive=!1,e.push(b);a===m||!d.hasRendered||!f?g():f&&setTimeout(g,f)
            });
...
destroy:function(a){
    ...
    a||X(b);
    for(d in c)Pa(c[d]),c[d]=null;q([b.ticks,b.minorTicks,b.alternateBands],function(a){
        Pa(a)
        });
...
na.prototype.normalizeTimeTickInterval=function(a,b){
    ...
    for(g=0;g<c.length;g++)if(d=c[g],e=A[d[0]],f=d[1],c[g+1]&&a<=(e*f[f.length-1]+A[c[g+1][0]])/2)break;e===A.year&&a<5*e&&(f=[1,2,5]);
    ...
    runPointActions:function(a){
        ...
        if(d&&this.options.tooltip.shared&&(!h||!h.noSharedTooltip)){
            ...
            for(j=0;j<i;j++)if(c[j].visible&&c[j].options.enableMouseTracking!==!1&&!c[j].noSharedTooltip&&
                c[j].singularTooltips!==!0&&c[j].tooltipPoints.length&&(e=c[j].tooltipPoints[l])&&e.series)e._dist=Q(l-e.clientX),k=L(k,e._dist),f.push(e);for(i=f.length;i--;)f[i]._dist>k&&f.splice(i,1);
...
lb.prototype={
    ...
    colorizeItem:function(a,b){
        ...
        if(f){
            if(g&&f.isMarker)for(j in i.stroke=h,g=a.convertAttribs(g),g)d=g[j],d!==u&&(i[j]=d);f.attr(i)
            }
        },
...
Ya.prototype={
    ...
    if(e)for(g in e)N(f,g,e[g]);f.xAxis=[];
    f.yAxis=[];
...
redraw:function(a){
    ...
    if(h)for(l=k;l--;)if(a=c[l],a.options.stacking)a.isDirty=!0;q(c,function(a){
...
O.prototype={
    ...
    init:function(a,b){
        ...
        if(ga)b.animation=!1;
        e=b.events;
        for(d in e)N(c,d,e[d]);if(e&&e.click||b.point&&b.point.events&&b.point.events.click||b.allowPointSelect)a.runTrackerClick=!0;
        c.getColor();
        c.getSymbol();
    ...
    setData:function(a,b,c,d){
        ...
        if(d!==!1&&h&&g===h&&!e.cropped&&!e.hasGroupedData)q(a,function(a,b){
            ...
            if(o&&h>o){
                ...
                series:e
            },e.pointClass.prototype.applyOptions.apply(i,[a[c]]),e.updateParallelArrays(i,c),n&&i.name))l.names[i.x]=i.name;Ga(t[0])&&ha(14,!0);
            e.data=[];
            e.options.data=a;
            for(c=g;c--;)f[c]&&
...
generatePoints:function(){
    ...
    if(b&&(g!==(c=b.length)||
        j))for(n=0;n<c;n++)if(n===h&&!j&&(n+=g),b[n])b[n].destroyElements(),b[n].plotX=u;this.data=b;
    this.points=l
    },
...
getAttribs:function(){
    ...
    if(!i||g<i||k)for(;g--;){
        ...
        k=b.colorByPoint||
        i.color;
        if(i.options)for(p in l)s(c[l[p]])&&(k=!0);if(k){
            c=c||{};
...
r(O.prototype,{
    ...
    update:function(a,b){
        ...
        this.remove(!1);
        for(i in g)g.hasOwnProperty(i)&&(this[i]=u);r(this,H[a.type||f].prototype);
        q(h,function(a){
            c[a]=h[a]
            });
        this.init(d,a);
...
var qa=ma(O,{
    ...
    getSegments:function(){
        ...
        if(this.options.stacking&&!this.cropped){
            ...
            for(m in g)g[m].total!==null&&d.push(+m);d.sort(function(a,b){
                return a-b
                });
            q(d,function(b){
                var d=0,k;
        ...
        j=a.plotGroup("dataLabelsGroup","data-labels",d.defer?"hidden":"visible",d.zIndex||6),p(d.defer,!0)&&(j.attr({
            ...
            if(h&&!e)b.dataLabel=h.destroy();
                ...
                if(h)if(s(i))h.attr({
                    ...
                    for(o in h)h[o]===u&&delete h[o];h=b.dataLabel=a.chart.renderer[e?"text":"label"](i,0,-999,null,null,null,d.useHTML).attr(h).css(r(d.style,c&&{
                        cursor:c
...
T=K.TrackerMixin={
    drawTrackerPoint:function(){
        var a=
        this,b=a.chart,c=b.pointer,d=a.options.cursor,e=d&&{
            cursor:d
        },f=function(c){
            var d=c.target,e;
...
r(Fa.prototype,{
    ...
    importEvents:function(){
        if(!this.hasImportedEvents){
            ...
            this.events=a;
            for(b in a)N(this,b,a[b]);this.hasImportedEvents=!0
            }
        },
