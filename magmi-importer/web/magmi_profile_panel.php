...
<span>Configure Current Profile: <strong><?php echo $profilename?></strong></span>
<?php 
...
<span style="float:right">
	<a id="saveprofile" class="actionbutton savebutton" href="javascript:void(0)" <?php if(!$conf_ok){?>disabled="disabled"<?php }?>>Save Profile (<?php echo $profilename?>)</a>
</span>
...
<div class="grid_12 col">
	...
	<div class="formline">
		<span class="label">Current Magmi Profile:</span>
		...
		<span class="label">Copy Selected Profile to:</span>
		<input type="text" name="newprofile"></input>
		
		<input type="submit" value="Copy Profile &amp; switch"  class="copy-select-profile" sty></input>
	</div>
...
<div class="container_121" id="profile_cfg">
<br />
