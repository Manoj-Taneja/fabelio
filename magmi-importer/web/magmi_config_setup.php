	...
	<div class="container_12">
		<div class="grid_12">
			<div style="float:right">
				<a id="save_commonconf" class="actionbutton save-global" href="#">Save global parameters</a>
			</div>
		</div>
	</div>
</div>
...
<div class="container_12" style="clear:both;" >
	<div class="subtitle-left"></div>
	<div class="grid_12 subtitle"><span>Update Magmi</span></div>
	<div class="subtitle-right"></div>
</div>
<div class="dash_tabs_left">
<div class="dash_tabs_right">
...
<div class="container_12">
<?php if($zipok){?>
<form class="magmi-release" method="post" enctype="multipart/form-data" action="magmi_upload.php">
...
<!--  PLUGIN UPLOADER -->
<div class="container_12">
<form class="magmi-release" method="post" enctype="multipart/form-data" action="plugin_upload.php">
...
<div class="container_12">
<div class="grid_12">
<a class="advance-utility" href="magmi_utilities.php"></a>
</div>
</div>
