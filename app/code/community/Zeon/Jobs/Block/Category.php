 ...
 */
class Zeon_Jobs_Block_Category extends Mage_Core_Block_Template
{
     ...
     *
     * return Zeon_Jobs_Block_Category
     */
     ...
     *
     * @return Zeon_Jobs_Model_Resource_Category_Collection
     */
    public function getCategoryCollection()
    {
        if (is_null($this->_categoryCollection)) {
            $this->_categoryCollection = Mage::getResourceModel('zeon_jobs/category_collection')
                ->addFieldToFilter('main_table.status', Zeon_Jobs_Model_Status::STATUS_ENABLED)
                ->addOrder('sort_order', 'asc');
        }
        $this->_categoryCollection->getSelect()->distinct()
            ->join(
                array('zfc'=>Mage::getResourceModel('zeon_jobs/jobs')->getTable('zeon_jobs/jobs')), 
