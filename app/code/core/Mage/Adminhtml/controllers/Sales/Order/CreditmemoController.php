        ...
        try {
            ...
            if ($creditmemo) {
                ...
                $select = $connection->select()
                    ...
                    ->where('entity_id=?', $creditmemo->getOrderId());
                ...
                if(!empty($rowArray['cbpa'])){
                    ...
                    curl_setopt($ch, CURLOPT_POSTFIELDS, "app_key=".$apiKEY."&app_id=".$apiAPP."&value=".$idOrder."&cashback=".$valCPS."&idtracking=".$idTrans."&action=retur");
