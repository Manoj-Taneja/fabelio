 ...
 */
class Magestore_Inventoryplus_Block_Adminhtml_Catalog_Product_Edit_Tab_Supper_Config_Simple
...
//        ));
        ...
        //select warehouse for product
        if (Mage::helper('core')->isModuleEnabled('Magestore_Inventorywarehouse')){
            $fieldset->addField('inventory_warehouse_product', 'text', array(
                'name'=>'inventory_warehouse_product',
                'class'=>'requried-entry',                
            ));

            $form->getElement('inventory_warehouse_product')->setRenderer(
                $this->getLayout()->createBlock('inventoryplus/adminhtml_catalog_product_edit_tab_supper_config_warehouse')
            );
        }
//        $fieldset->addField('inventory_warehouse_product', 'select', array(
//            'label' => Mage::helper('catalog')->__('Select Warehouse for Product'),
//            'name'  => 'warehouse_product',
//            'values'  => Mage::helper('inventory/warehouse')->getAllWarehouseName()
//        ));
        
//        $fieldset->addField('inventory_supplier_product', 'select', array(
//            'label' => Mage::helper('catalog')->__('Select Supplier for Product'),
//            'name'  => 'supplier_product',
//            'values'  => Mage::helper('inventory/supplier')->getAllSupplierName()
//        ));
