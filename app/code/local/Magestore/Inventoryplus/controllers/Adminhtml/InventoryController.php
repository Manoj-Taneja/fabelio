 ...
 */
class Magestore_Inventoryplus_Adminhtml_InventoryController extends Mage_Adminhtml_Controller_Action
{
    /**
        ...
        if ($data = $this->getRequest()->getPost()) {
            ...
            try {
                ...
                Mage::getSingleton('adminhtml/session')->addSuccess(
                    Mage::helper('inventoryplus')->__('Item was successfully saved')
                );
    ...
    public function exportCsvAction()
    {
        ...
        $content    = $this->getLayout()
                           ->createBlock('inventoryplus/adminhtml_inventory_grid')
                           ->getCsv();
