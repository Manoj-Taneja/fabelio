 ...
 */ 
    ...
    class Ptech_Multilayer_Model_Layer_Filter_Price extends Mage_Catalog_Model_Layer_Filter_Price
    {
        ...
        {
            $data = array();   
            $style = Mage::getStoreConfig('multilayer/multilayer/price_style'); 
            if ('default' == $style)
            {
        ...
        protected function _getCacheKey()
        {
            ...
            $key .= Mage::getStoreConfig('multilayer/multilayer/price_style');
            $key .= Mage::helper('multilayer')->getCacheKey('price');
            return $key;
        }   
        
        private function getFilterValueFromRequest()
        {
            $filter = Mage::helper('multilayer')->getParam($this->_requestVar);
        ...
        public function apply(Zend_Controller_Request_Abstract $request, $filterBlock)
        {
            ...
            if ('default' == Mage::getStoreConfig('multilayer/multilayer/price_style'))
            {
