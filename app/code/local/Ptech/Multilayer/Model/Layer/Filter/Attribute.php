 ...
 * @Class        Ptech_Multilayer_Model_Layer_Filter_Attribute
 * @Overwrite    Mage_Catalog_Model_Layer_Filter_Attribute
 */ 
class Ptech_Multilayer_Model_Layer_Filter_Attribute extends Mage_Catalog_Model_Layer_Filter_Attribute
{
    ...
    protected function _getItemsData()
    {
        ...
        $key .= Mage::helper('multilayer')->getCacheKey($this->_requestVar);
        ...
        if ($data === null) {
            ...
            $currentIds = Mage::helper('multilayer')->getParam($attribute->getAttributeCode());
            $tags = array(
