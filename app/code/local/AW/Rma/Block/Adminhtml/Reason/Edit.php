...
class AW_Rma_Block_Adminhtml_Reason_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
        if (!Mage::registry('awrmaformdatareason')) {
            return $this->__('New RMA Reason');
        } else {
            return $this->__('Edit RMA Reason');
        }
    }
}