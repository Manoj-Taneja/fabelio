...
class AW_Rma_Block_Adminhtml_Types_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_formScripts[] = "function awrmaSaveAndContinueEdit() {
    ...
    public function getHeaderText()
    {
        if (!Mage::registry('awrmaformdatatype')) {
            return $this->__('New RMA Type');
        } else {
            return $this->__('Edit RMA Type');
        }
    }
}