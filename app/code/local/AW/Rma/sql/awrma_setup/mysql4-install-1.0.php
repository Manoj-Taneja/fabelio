...
try {
    $installer->run("
        ...
        INSERT IGNORE INTO `{$this->getTable('awrma/entity_types')}` (`id`, `name`, `store`, `sort`) VALUES (1, '" . $helper->__('Replacement') . "', 0, 1);
        INSERT IGNORE INTO `{$this->getTable('awrma/entity_types')}` (`id`, `name`, `store`, `sort`) VALUES (2, '" . $helper->__('Refund') . "', 0, 2);
