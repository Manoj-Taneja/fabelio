...
class Kellton_Matrixrate_Model_Carrier_Matrixrate
    ...
    implements Mage_Shipping_Model_Carrier_Interface
{
    ...
    protected $_default_condition_name = 'sku';
    ...
    {
        parent::__construct();
        foreach ($this->getCode('condition_name',$this->_default_condition_name) as $k=>$v) {
            $this->_conditionNames[] = $k;
        }
        //echo "<pre>"; print_r($this->_conditionNames[]); echo "</pre>";
      //  exit;
    }
   ...
   /* public function getAllowedMethods()
    ...
    public function getCode($type, $code='')
    {
       // echo "<pre>"; print_r($code); echo "</pre>";
        ...
        $codes = array(
            ...
            'condition_name'=>array(
                ...
                'sku'    => Mage::helper('shipping')->__('SKU'),
            ),
     ...
     //  echo "<pre>"; print_r($codes[$type]); echo "</pre>";
     // exit; 
        if (!isset($codes)) {
