...
class Sprint_Migs_Model_Bcacredit extends Mage_Payment_Model_Method_Abstract {
	protected $_code = 'bcacredit';
	
	protected $_isInitializeNeeded      = true;
	protected $_canUseInternal          = true;
	protected $_canUseForMultishipping  = true;
	
	protected $_formBlockType = 'migs/payment_form_bcacredit';
