            ...
            array(
                ...
                array(
                    ...
                    'value' => array(
                        ...
                        array(
                            'label' => Mage::helper('amlanding')->__('Min Price'),
                            'value' => 'amlanding/filter_condition_price_min'
                        ),
                        array(
                            'label' => Mage::helper('amlanding')->__('Max Price'),
                            'value' => 'amlanding/filter_condition_price_max'
                        ),
                        array(
                            'label' => Mage::helper('amlanding')->__('Final Price'),
                            'value' => 'amlanding/filter_condition_price_final'
                        ),
                    )
                ),
                array(
