 ...
 */
    ...
    class Amasty_Xlanding_Model_Filter_Condition_Price_Final extends Amasty_Xlanding_Model_Filter_Condition_Abstract
    {
        ...
        public function collectConditionSql($collection)
        {
            ...
            return $this->getOperatorCondition('price_index.final_price', $operator, $value);
        }
