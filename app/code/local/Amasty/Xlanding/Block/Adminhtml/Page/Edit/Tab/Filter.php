...
class Amasty_Xlanding_Block_Adminhtml_Page_Edit_Tab_Filter
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('filter_title', 'text', array(
          'name'     => 'filter_title',
          'label'    => $helper->__('Title'),
          'title'    => $helper->__('Title'),
          'note'     => "Give a title to the products expected to display on current landing page."
        ));
        ...
        $fieldset->addField('extra_categories', 'text', array(
          'name'     => 'extra_categories',
          'label'    => $helper->__('Extra Categories'),
          'title'    => $helper->__('Extra Categories'),
          'note'     => "Categories separated by commans without space. Ex: 280:1,211:0, means show all products of category 280 and show only 3 products of category 211"
        ));
