...
$sql="select a.entity_id,a.increment_id from fabelio.sales_flat_order a inner join fabelio.sales_flat_order_item b on a.entity_id = b.order_id where (a.status='processing' or a.status='processing_manufacturing23' or a.status='processing_poraised') and b.sku='".$_GET['sku']."'";
$sql1="select increment_id,entity_id from fabelio.sales_flat_order where entity_id='".$_GET['ordernumber']."'";
...
<form class="form-horizontal" action="input_qcship.php" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
    	<input class="form-control" id="qcid" type="hidden" value="<?php echo $_GET['qcid']; ?>" name="qcid">
	</div>
	...
	<div class="form-group">
    	...
    	<input class="form-control" id="sku" type="text" value="<?php echo $_GET['sku']; ?>" placeholder="<?php echo $_GET['sku']; ?>" name="sku" readonly="readonly">
	</div>
	<div class="form-group">
		<label for="productname" class="control-label">Product Name</label> 
    	<input class="form-control" id="productname" type="text" value="<?php echo $_GET['productname']; ?>" placeholder="<?php echo $_GET['productname']; ?>" name="productname" readonly="readonly">
	</div>
	...
	<div id="customerorder" style="display:none;">
		<div class="form-group">
			<label for="manualorder" class="control-label">Manual Order Number (B2B)</label> 
			<input class="form-control" id="manualorder" type="text" name="manualorder" onkeyup="manual_order(this.value)" value="<?php echo $_GET['manualordernumber']; ?> " placeholder="<?php echo $_GET['manualordernumber']; ?> ">
		</div>
			...
			if ($result->num_rows > 0) {
			    ...
			    <div class="form-group" id="ordernumber">
			        <label id ="orderlabel" for="orderid" class="control-label">Order Number:<?php echo $row1["increment_id"]; ?> </label>
			        <select name="orderid" onchange="showorder(this.value)" class="form-control" id="ordernumber">
			    ...
			    <div class="form-group">
			        ...
			        <input class="form-control" id="ordertype" type="text" value="<?php echo $_GET['ordertype']; ?> " placeholder="<?php echo $_GET['ordertype']; ?> " readonly="readonly">
			    </div>
			...
			<?php 
			    ...
			    <div class="form-group">
			        <label for="ordertype" class="control-label">Order Type</label> 
			        <input class="form-control" id="ordertype" type="text" value="<?php echo $_GET['ordertype']; ?>" placeholder="<?php echo $_GET['ordertype']; ?>" name="order_type" readonly="readonly">
			    </div>
