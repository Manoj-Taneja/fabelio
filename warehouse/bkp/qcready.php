...
<body>
<center>
<legend>Items which are Ready To Ship</legend>
<div class="container">
<div class="table-responsive">
	<br>
	<table id="qcready" class="table table-hover table-bordered">
	<thead>
	<tr>
	    <th>Item ID</th>
	    <th>SKU</th>
  	...
  	<tbody>
  		<?php
			...
			<td id="qcid-<?php echo $i; ?>"  style="display:none"><?php echo $row['qc_id'] ;?></td>
